...
bool PD_MM_Room::AddLogicTilePos(PD_MG_LogicPosition logpos) { return LogicTilesPosInRoom.AddUnique(logpos) >= 0; }
bool PD_MM_Room::AddLogicWallPos(PD_MG_LogicPosition logpos) { return LogicWallPosInRoom.AddUnique(logpos) >= 0; }
bool PD_MM_Room::AddLogicDoorPos(PD_MG_LogicPosition logpos) { return LogicDoorPosInRoom.AddUnique(logpos) >= 0; }
